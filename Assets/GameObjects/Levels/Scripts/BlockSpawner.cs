...
public class BlockSpawner : MonoBehaviour
{
    ...
    public List<GameObject> CreateBlockFromImage(LevelInfo levelInfo, Transform transform, GameObject obje, Transform blockContainer2)
    {
    ...
    public List<GameObject> CreatedCubes(LevelInfo levelInfo, Transform transform, int cubeCount)
    {
